#!/usr/bin/env python3
"""
Seed script — Creates demo users, categories, and products.
...
# ── Products ────────────────────────────────────────────────────────────────────
products_data = [
    {'name': 'Fresh Tomatoes', 'category': 'vegetables', 'price': 35, 'quantity': 200, 'unit': 'kg', 'is_organic': False, 'description': 'Farm-fresh red tomatoes, perfect for cooking.'},
    {'name': 'Organic Spinach', 'category': 'vegetables', 'price': 55, 'quantity': 80, 'unit': 'kg', 'is_organic': True, 'description': 'Pesticide-free organic spinach, rich in iron.'},
    {'name': 'Alphonso Mangoes', 'category': 'fruits', 'price': 420, 'quantity': 50, 'unit': 'dozen', 'is_organic': False, 'description': 'Premium Alphonso mangoes from Ratnagiri.'},
    {'name': 'Basmati Rice', 'category': 'grains', 'price': 85, 'quantity': 500, 'unit': 'kg', 'is_organic': False, 'description': 'Long-grain aromatic Basmati rice.'},
    {'name': 'Turmeric Powder', 'category': 'spices', 'price': 180, 'quantity': 30, 'unit': 'kg', 'is_organic': True, 'description': 'Pure organic turmeric with high curcumin content.'},
    {'name': 'Toor Dal', 'category': 'pulses', 'price': 120, 'quantity': 150, 'unit': 'kg', 'is_organic': False, 'description': 'Premium quality Toor dal (split pigeon peas).'},
    {'name': 'Fresh Carrots', 'category': 'vegetables', 'price': 40, 'quantity': 120, 'unit': 'kg', 'is_organic': False, 'description': 'Crunchy fresh carrots from the farm.'},
    {'name': 'Organic Bananas', 'category': 'fruits', 'price': 60, 'quantity': 100, 'unit': 'dozen', 'is_organic': True, 'description': 'Organic bananas, naturally ripened.'},
]
...
print(f'  [OK] {len(products_data)} products with price history')
print('')
print('[DONE] Seed complete! You can now run the servers.')
